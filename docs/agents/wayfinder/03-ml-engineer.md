...
## Status
- **ACTIVE**: Datasets are generated (1,000 missions in `data/`). The next step is to build a proof-of-concept model (anomaly detection baseline or supervised classifier) to validate the diagnostic capabilities.
