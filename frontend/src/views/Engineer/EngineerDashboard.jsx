...
import DegradationTrajectoryChart from '../../components/widgets/DegradationTrajectoryChart';
  ...
  return (
    <div className="engineer-dashboard">
      ...
      <section className="mission-context-bar card">
        ...
        <div className="context-item" style={{ minWidth: '130px' }}>
          <div className="label" style={{ display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
            RUL
            {isLive && missionContext.rulSource && (
              <span style={{
                fontSize: '0.55rem',
                fontWeight: 600,
                padding: '1px 4px',
                borderRadius: '2px',
                backgroundColor: missionContext.rulSource === 'lstm' ? 'var(--color-good)' : 'var(--color-warning)',
                color: '#000',
              }}>
                {missionContext.rulSource === 'lstm' ? 'LSTM' : 'SIM'}
              </span>
            )}
          </div>
      ...
      <main className="dashboard-grid">
        ...
        <div className="grid-area-degradation-trajectory card">
